...
const Item: React.FC<{
  ...
  >
    ...
    {icon}
    <span
      className={`text-[10px] mt-1 ${active ? "font-black" : "font-semibold"}`}
    >
      {label}
    </span>
  </button>
  ...
  >
    <div className="flex items-end justify-around">
      ...
      >
        ...
        <span
          className={`text-[10px] mt-1 ${activeTab === "eligibility" ? "font-black text-sky-700 dark:text-sky-400" : "font-bold text-slate-600 dark:text-slate-400"}`}
        >
          যোগ্যতা
        </span>
      </motion.button>

      {/* 4️⃣ ক্যালেন্ডার (ডান পাশে) */}
      <Item
        label="ক্যালেন্ডার"
